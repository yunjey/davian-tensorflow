...
class DCGAN(object):
    ...
    Discriminator and generator are trained jointly by minimax algorithm
    """
    
    def __init__(self, batch_size=100, learning_rate=0.0002, image_size=64, output_size=64, 
                 dim_color=3, dim_z=100, dim_gf=64, dim_df=64):
        """
        Args:
            ...
            dim_c: (optional) dimension of image color; for gray scale image, set to 1
        ...
        # batch normalization layer for generator and discriminator
    ...
    def generator(self, z, reuse=False):
        ...
        Args:
            z: random input for generating images of shape (batch_size, dim_z)
        ...
        with tf.variable_scope('generator', reuse=reuse):
            ...
            out = tf.nn.tanh(deconv2d(h4, [self.batch_size, s, s, self.dim_color], name='g_out'))  # (batch_size, 64, 64, dim_color)
    ...
    def discriminator(self, images, reuse=False):
        ...
        Args: 
            images: real or generated images of shape (batch_size, image_size, image_size, dim_color)  
        
        Returns:
            out: probabilties for whether it is a real image or a fake image, of shape (batch_size,)
        """
