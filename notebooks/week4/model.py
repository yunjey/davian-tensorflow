...
class DCGAN(object):
    ...
    def build_model(self):
        ...
        with tf.name_scope('optimizer'):
            self.d_optimizer = tf.train.AdamOptimizer(learning_rate=self.learning_rate, beta1=0.5).minimize(self.d_loss)
            self.g_optimizer = tf.train.AdamOptimizer(learning_rate=self.learning_rate, beta1=0.5).minimize(self.g_loss)                  
